...
class MainUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        with open("nameslist.txt", "r") as f:
            ...
            for i in z:
                names.add(i)
        self.title_font = tkfont.Font(family='Enriqueta-SemiBold', size=20, weight="bold")
...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            #load = Image.open("face_detection_image.png")
            #load = load.resize((250, 250), Image.ANTIALIAS)
            render = PhotoImage(file='face_detection_image.png')
